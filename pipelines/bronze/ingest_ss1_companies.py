"""
ingest_ss1_companies.py
-----------------------
Ingests files with name pattern companies_*.csv from Source System 1 into
the configured bronze schema's ss1_companies table.

Run from project root:
    export LAKEHOUSE_ENV=dev   # or test, prod
    python pipelines/bronze/ingest_ss1_companies.py
"""
...
spark = get_spark_session("ingest-ss1-companies")

csv_ingestor.run(
    source_system = "ss1",
    source_dir    = CONFIG["file_sources"]["ss1_dir"],
    name_pattern  = "companies_*.csv",
